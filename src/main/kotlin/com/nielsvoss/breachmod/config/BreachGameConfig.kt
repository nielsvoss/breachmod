    ...
    companion object {
        ...
        val CODEC : MapCodec<BreachGameConfig> = RecordCodecBuilder.mapCodec { instance ->
            instance.group(
                ...
                Codec.INT.optionalFieldOf("score_needed_to_win", 3).forGetter(BreachGameConfig::scoreNeededToWin),
                ...
                Codec.INT.optionalFieldOf("number_of_targets", 2).forGetter(BreachGameConfig::numberOfTargets),
                Codec.BOOL.optionalFieldOf("outline_targets", true).forGetter(BreachGameConfig::outlineTargets),
                Codec.BOOL.optionalFieldOf("remaining_players_popup", true).forGetter(BreachGameConfig::remainingPlayersPopup)
